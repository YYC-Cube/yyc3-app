...
[![Platform Status](https://img.shields.io/badge/status-production--ready-green.svg)](https://github.com/YY-Nexus/0379-email-platform)
...
```bash
# 1. 克隆项目
git clone git@github.com:YY-Nexus/0379-email-platform.git
...
logging:
  ...
  outputs:
    - console
    - file: /var/log/email-platform/app.log
```
