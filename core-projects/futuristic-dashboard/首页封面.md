    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between px-4 sm:px-6 py-4 lg:px-12">
        <div className="flex items-center space-x-2 pl-3 sm:pl-6 lg:pl-12">
          <img src="/yyc3-logo.png" alt="Logo" className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12" />
        </div>
...
:root {
  ...
  --speed: 1s; /* Assuming a default speed for animations */
}
...
@theme inline {
  ...
  /* Adding shimmer button animations */
...
## components/line-shadow-text.tsx
