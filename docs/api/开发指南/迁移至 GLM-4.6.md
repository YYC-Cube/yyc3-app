...
<CardGroup cols={2}>
  <Card title="核心参数" icon={<svg style={{maskImage: "url(/resource/icon/star.svg)",
maskRepeat: "no–repeat",
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"}/>} href="/cn/guide/start/concept–param">
    模型常见参数概念与采样建议
  </Card>

  <Card title="工具流式输出" icon={<svg style={{maskImage: "url(/resource/icon/code.svg)",
maskRepeat: "no–repeat",
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"}/>} href="/cn/guide/capabilities/stream–tool">
    查看工具流式输出使用详情
  </Card>
