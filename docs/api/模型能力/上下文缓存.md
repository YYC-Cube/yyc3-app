...
<CardGroup cols={2}>
  <Card title="多轮对话" icon={<svg style={{maskImage: "url(/resource/icon/headset.svg)", WebkitMaskImage: "url(/resource/icon/headset.svg)",
...
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"} />}>
  ...
  <Card title="批量处理" icon={<svg style={{maskImage: "url(/resource/icon/cubes.svg)", WebkitMaskImage: "url(/resource/icon/cubes.svg)",
maskRepeat: "no–repeat",
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"} />}>
    * 代码审查批处理
    * 内容批量分析
  ...
  <Card title="模板化应用" icon={<svg style={{maskImage: "url(/resource/icon/rectangle–list.svg)", WebkitMaskImage: "url(/resource/icon/rectangle–list.svg)",
maskRepeat: "no–repeat",
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"} />}>
    * 报告生成模板
    * 标准化流程处理
  ...
  <Card title="教育培训" icon={<svg style={{maskImage: "url(/resource/icon/glasses.svg)", WebkitMaskImage: "url(/resource/icon/glasses.svg)",
maskRepeat: "no–repeat",
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"} />}>
    * 作业批改辅助
    * 学习资料解析
