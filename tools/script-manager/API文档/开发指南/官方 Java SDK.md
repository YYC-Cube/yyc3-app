...
<CardGroup cols={2}>
  <Card title="企业级" icon={<svg style={{maskImage: "url(/resource/icon/building.svg)",
maskRepeat: "no–repeat",
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"}/>}>
    专为企业应用设计，支持高并发、高可用性
  </Card>

  <Card title="易于集成" icon={<svg style={{maskImage: "url(/resource/icon/plug.svg)",
maskRepeat: "no–repeat",
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"}/>}>
    简洁的 API 设计，完善的文档，快速集成到现有项目
  </Card>

  <Card title="类型安全" icon={<svg style={{maskImage: "url(/resource/icon/shield–check.svg)",
maskRepeat: "no–repeat",
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"}/>}>
    完整的类型定义，编译时错误检查，减少运行时错误
  </Card>

  <Card title="高性能" icon={<svg style={{maskImage: "url(/resource/icon/gauge–high.svg)",
maskRepeat: "no–repeat",
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"}/>}>
...
<CardGroup cols={2}>
  <Card title="Java 版本" icon={<svg style={{maskImage: "url(/resource/icon/java.svg)",
maskRepeat: "no–repeat",
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"}/>}>
    Java 1.8 或更高版本
  </Card>

  <Card title="构建工具" icon={<svg style={{maskImage: "url(/resource/icon/hammer.svg)",
maskRepeat: "no–repeat",
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"}/>}>
...
<CardGroup cols={2}>
  <Card title="GitHub 仓库" icon={<svg style={{maskImage: "url(/resource/icon/github.svg)",
maskRepeat: "no–repeat",
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"}/>} href="https://github.com/zai–org/z–ai–sdk–java">
    查看源代码、提交问题、参与贡献
  </Card>

  <Card title="API 参考" icon={<svg style={{maskImage: "url(/resource/icon/book.svg)",
maskRepeat: "no–repeat",
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"}/>} href="/cn/api/introduction">
    查看完整的 API 文档
  </Card>

  <Card title="示例项目" icon={<svg style={{maskImage: "url(/resource/icon/code.svg)",
maskRepeat: "no–repeat",
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"}/>} href="https://github.com/zai–org/z–ai–sdk–java/tree/main/samples">
    浏览更多实际应用示例
  </Card>

  <Card title="最佳实践" icon={<svg style={{maskImage: "url(/resource/icon/star.svg)",
maskRepeat: "no–repeat",
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"}/>} href="https://github.com/zai–org/z–ai–sdk–java">
    学习 SDK 使用的最佳实践
  </Card>
