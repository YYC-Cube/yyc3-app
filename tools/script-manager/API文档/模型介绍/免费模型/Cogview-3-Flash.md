...
<Tabs>
  <Tab title="PPT 配图">
    ...
    <CardGroup cols={2}>
      <Card title="Prompt" icon={<svg style={{maskImage: "url(/resource/icon/arrow–down–right.svg)",
...
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"}/>}>
      ...
      <Card title="生成图片" icon={<svg style={{maskImage: "url(/resource/icon/arrow–down–left.svg)",
maskRepeat: "no–repeat",
maskPosition: "center center",}} className={"h–6 w–6 bg–primary dark:bg–primary–light !m–0 shrink–0"}/>}>
