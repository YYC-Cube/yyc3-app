...
打开 providers.json 文件，找到 GLM 相关配置，将原始的 API 地址：

```
"https://open.bigmodel.cn/api/paas/v4"
```

修改为 GLM Coding 套餐专用端点：

```
"https://open.bigmodel.cn/api/coding/paas/v4"
```

![Description](https://cdn.bigmodel.cn/markdown/1758090697604crush–2.jpeg?attname=crush–2.jpeg)
这将确保您的请求与 GLM–4.6 模型兼容。
...
参考 [视觉MCP服务器](../mcp/vision–mcp–server) 和 [搜索MCP服务器](../mcp/search–mcp–server) 文档，配置完成后即可在 Crush 中使用。
